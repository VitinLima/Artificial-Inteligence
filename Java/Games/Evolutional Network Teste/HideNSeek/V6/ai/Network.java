...
public class Network{
	private AI[] ais;
	private int[] eff;
	private boolean backPropagate = true;
	...
	public int getEff(int id){
		return eff[id];
	}
	
	public AI access(int id){
		return ais[id];
	}
	
	public void setBackPropagate(boolean backPropagate){
