...
public class Dentrite{
	...
	public void randomize(){
		multiplier *= (float)Math.random()*2.0f;
	}
	public Dentrite copy(){
		return new Dentrite(isActivating,isChecked,multiplier,correction,neuron);
	}
	public Dentrite(boolean isActivating, boolean isChecked, float multiplier, float correction, Neuron neuron){
		this.neuron = neuron;
	...
	public void updateDentrite(Neuron[] Ns){
		this.neuron = Ns[this.neuron.getId()];
	}
}