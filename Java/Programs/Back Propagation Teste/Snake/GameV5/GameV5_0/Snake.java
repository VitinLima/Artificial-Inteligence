...
public class Snake extends Entity{
	...
	public Snake(int new_id, Color new_color, Object new_exit_obj, Game_Object new_game_obj, Object new_master_obj){
		...
		field_of_view = 3;
		//neural_network = new NeuralNetwork(2*(2*field_of_view+1)*(2*field_of_view+1), 20, 4);
		neural_network = new NeuralNetwork(new int[]{2*(2*field_of_view+1)*(2*field_of_view+1), 4});
		//System.out.println(neural_network.fget_data());
	}
	...
	public void fkill(int choice){
		...
		neural_network.fback_propagation(incentive);
		deaths++;
		frespawn();
	}
	public void fgrow(){
