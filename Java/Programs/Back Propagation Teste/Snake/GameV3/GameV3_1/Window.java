...
public class Window extends JFrame{
	...
	public Window(Map map, Snake[] snakes, Fruit[] fruits, Object game_obj, Object master_obj){
		...
		window_buttons = new Window_Buttons(snakes, game_obj, master_obj, pause_obj, hide_obj);
		window_map = new Window_Map(map.fget_grid(), game_obj, master_obj, pause_obj, hide_obj);
		add(window_buttons);
		add(window_map);
