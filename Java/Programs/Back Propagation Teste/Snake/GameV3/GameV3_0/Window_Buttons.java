...
public class Window_Buttons extends JComponent implements KeyListener{
	...
	public Window_Buttons(Object new_pause_obj, Object new_hide_obj, Object spy_obj, Snake[] snakes){
		...
		tempbutton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				window_spy = new Window_Spy(spy_obj, snakes);
				window_spy.addWindowListener(new WindowAdapter(){
					...
					public void windowClosing(WindowEvent e){
						...
						window_spy.dispose();
						window_spy = null;
						//System.out.println("Closing Spy");
					}
				});
			}
		});
